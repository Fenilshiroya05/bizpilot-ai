 ...
 * Updated in Phase 12: V10 added {@code TASK_READ}/{@code CREATE}/
 ...
 * represents. Updated again in Phase 13: V11 added only
 * {@code DOCUMENT_DELETE} — {@code DOCUMENT_READ}/{@code DOCUMENT_UPLOAD}
 * already existed since V4 (CLAUDE.md §9's original catalog named them
...
class RoleSeedDataTests {
     ...
     * {@code DOCUMENT_DELETE} (Phase 13) does not change this — EMPLOYEE
     * never had {@code DOCUMENT_UPLOAD} either, and still doesn't.
     */
    @Test
